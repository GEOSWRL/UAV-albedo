...
sns.set(rc={'figure.figsize':(3.35,3.35)}) #fig size in inches
sns.set(font="Arial")
...
ln1 = sns.lineplot(ax = ax1, data = df.loc[df['Altitude (m)'] == 10], x='FOV', y='Irradiance Fraction', color=pallete[0], 
                   label='')
ln2 = sns.lineplot(ax = ax1, x=[0,180], y=[0,1], color=pallete[7], 
...
ax1.set(xlim=(0,180), ylim=(0,1.01))
...
#ines_1, labels_1 = ln1.get_legend_handles_labels()
...
plt.savefig('C:/Users/x51b783/Documents/Mirror/Masters/writing/tarpaulin/figs/fraction_irradiance.tiff', bbox_inches="tight",dpi=300)
